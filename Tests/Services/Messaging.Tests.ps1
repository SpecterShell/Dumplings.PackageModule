...
BeforeDiscovery {
  ...
  Import-Module (Join-Path $Script:DumplingsModuleRoot 'Libraries\Messaging\Messaging.psm1') -Force
  Import-Module (Join-Path $Script:DumplingsModuleRoot 'Libraries\Messaging\Telegram.psm1') -Force
