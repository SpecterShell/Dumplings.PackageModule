...
BeforeAll {
  ...
  $Script:UtilityModule = Import-Module (Join-Path $Script:DumplingsModuleRoot 'Utilities' 'PlaywrightRuntime.psm1') -Force -PassThru
  $Script:LockPath = Join-Path $Script:DumplingsModuleRoot 'Assets' 'PlaywrightRuntime.psd1'
}
