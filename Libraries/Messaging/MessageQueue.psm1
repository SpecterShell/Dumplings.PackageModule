...
$ErrorActionPreference = 'Stop'
try {
  Import-Module (Join-Path $LibraryPath 'Data' 'Text.psm1') -Force
  Import-Module (Join-Path $LibraryPath 'Data' 'HTML.psm1') -Force
  Import-Module (Join-Path $LibraryPath 'Messaging' 'Messaging.psm1') -Force
  $QueueModule = Import-Module (Join-Path $LibraryPath 'Messaging' 'MessageQueue.psm1') -Force -PassThru
  Import-Module (Join-Path $LibraryPath 'Messaging' 'Telegram.psm1') -Force
  Import-Module (Join-Path $LibraryPath 'Messaging' 'Matrix.psm1') -Force
  & $QueueModule {
