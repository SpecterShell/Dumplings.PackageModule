...
# DOM traversal keeps HTML-only state separate from property-list parsing.
...
Export-ModuleMember -Function ConvertTo-HtmlDecodedText, Get-TextContent, Convert-MarkdownToHtml
